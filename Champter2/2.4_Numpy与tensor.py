...
# 生成图个单位矩阵
print("生成图个单位矩阵:", torch.eye(2, 2))
# 自动生成全是0的矩阵
print("自动生成全是0的矩阵", torch.zeros(2, 3))
# 根据规则生成数据
print("根据规则生成数据:", torch.linspace(1, 10, 4))
# 生成满足均匀分布随机数
print("生成满足均匀分布随机数:", torch.rand(2, 3))
# 生成满足标准分布随机数
print("生成满足标准分布随机数:", torch.randn(2, 3))
# 返回所给数据形状相同，值全为0的张量
print("返回所给数据形状相同，值全为0的张量:", torch.zeros_like(torch.rand(2, 3)))
...
# 生成是否大于0的Byter张量
mask = x>0
print("是否大于0的Byter张量:", mask)

# 获取非0下标，即行、列索引
print("非0下标:", torch.nonzero(mask))
...
print("torch.kthvalue 4:", b)
b = torch.kthvalue(a, 1)
print("torch.kthvalue 1:", b)
